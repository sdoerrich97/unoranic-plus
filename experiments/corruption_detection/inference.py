...
@description:
Inference of unORANIC+ for a corruption detection objective.
...
class Inference:
    ...
    def run_inference_for_single_set(self, set_loader, nr_batches):
        ...
        for i, (_, _, X, Y, _) in enumerate(set_loader):
...
def main(configuration):
    ...
    wandb.init(project="unoranic+_corruption_detection_inference", name=f"{configuration['dataset']}-{configuration['architecture_encoder']}", config=configuration)
